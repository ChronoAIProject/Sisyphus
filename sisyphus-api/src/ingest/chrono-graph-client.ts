...
export async function writeNodes(nodes: IngestGraphNode[]): Promise<WriteNodesResult> {
...
export async function writeEdges(edges: IngestGraphEdge[]): Promise<WriteEdgesResult> {
