...
import {
  writeNodes,
  writeEdges,
  type IngestGraphNode,
  type IngestGraphEdge,
...
interface IngestHistoryListResponse {
...
@Route("ingest/history")
@Tags("Ingest History")
export class IngestHistoryController extends Controller {
  /**
  ...
  ): Promise<IngestHistoryListResponse> {
